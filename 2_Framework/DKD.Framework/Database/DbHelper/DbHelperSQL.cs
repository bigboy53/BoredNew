...
namespace DKD.Framework.Database.DbHelper
{
    ...
    /// Modify By DKD 2014-9-15
    /// </summary>
    public class DbHelperSQL
    {
        public static string ConnectionString = "server=.;database=Bored;uid=sa;pwd=dukedi";
        ...
        /// 执行命令--返回结果集
        /// </summary>
        /// <param name="commadText">SQL命令</param>
        /// <param name="commandType">类型</param>
        /// <param name="parameters">参数</param>
        /// <returns></returns>
        public static SqlDataReader ExecuteReader(string commadText, CommandType commandType,
            params SqlParameter[] parameters)
        {
            ...
            {
                connection.Open();
                SqlCommand cmd = PrepareComand(connection, commadText, commandType, parameters);
                //SqlDataReader关闭时,连接也跟着关闭
        ...
        /// <param name="parameters">参数</param>
        /// <returns></returns>
        public static SqlCommand PrepareComand(SqlConnection conn, string commadText, CommandType commandType,
            params SqlParameter[] parameters)
        {
            SqlCommand cmd = new SqlCommand(commadText, conn);
            ...
            if (parameters != null)
            {
                ...
                {
                    if (paramter.Size < paramter.Value.ToString().Length)
                    {
                        paramter.Size = paramter.Value.ToString().Length + 1;
                    }
