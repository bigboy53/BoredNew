...
jQuery.fn.customInput = function(){
	$(this).each(function(i){	
		if($(this).is('[type=checkbox],[type=radio]')){
			...
			//        //input.re
			//        //debugger
            //        //var selectlabel = input.next(".checker");
            ...
            //        //        });
            //        //    };
            //        //    selectlabel.addClass('checked ');
            //        //}
			//        //else { selectlabel.removeClass('checked checkedHover checkedFocus '); }
			//        if (input.is(':checked') && !input.is(':disabled')) {
			//            var selectlabel = input.next(".checker");
			//            input.click();
			//            selectlabel.removeClass('checked checkedHover checkedFocus ');
			//        }
